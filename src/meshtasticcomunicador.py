...
class MeshtasticClass:
    def __init__(self):
        ...
        self.message_text = "Trabajo de Christian"
    ...
    def generate_mesh_packet(self,destination_id, encoded_message):
        ...
        mesh_packet.channel = self.generate_hash(self.channel)
    ...
    # Muestra la información en una sola línea
        return f"Nodo: {self.node_name}, Canal: {self.channel}, Posición: ({self.lat}, {self.lon}, {self.alt})"
